...
from rgcnformer_backend.core.config import get_logger
from rgcnformer_backend.core.paths import get_model_graph_json_path
from rgcnformer_backend.services.prediction import one_hot_encode_sequence, pad_or_truncate_sequence
from rgcnformer_backend.services.model_inspection import extract_module_info
...
@explainability_bp.route('/api/v1/model-architecture', methods=['GET'])
...
@explainability_bp.route('/api/v1/model-graph', methods=['GET'])
def get_model_graph():
    """
...
@explainability_bp.route('/api/v1/integrated-gradients', methods=['POST'])
...
@explainability_bp.route('/api/v1/visualize-gcn-aggregation', methods=['POST'])
